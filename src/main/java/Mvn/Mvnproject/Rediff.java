...
public class Rediff {
	...
	public void setExtent() {
		...
		htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") + "/Rediff-report/rediffReport.html");
		//"C:\\worksoft\\test"
		...
		extent.setSystemInfo("Pallavi", "localhost");
		extent.setSystemInfo("Environemnt", "QA");
		extent.setSystemInfo("user", "Pallavi");
		extent.setSystemInfo("OS","Windows 10");
		extent.setSystemInfo("Demo", "Rediff Reports");
	...
	public void setup() {
		...
		driver.get("http:/demo.rediff.com/");
	}
	...
	public void RediffTitleTest() {
		...
		Assert.assertEquals(title, "redifftitle");
	...
	public void RediffmoneyTest() {
		test = extent.createTest("RediffSignUpTest");
